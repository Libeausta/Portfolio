            ...
            ColumnLayout {
                    ...
                    Row {
                        ...
                        Repeater {
                            ...
                            Label {
                                ...
                                text: "*"
                                Layout.alignment: Qt.AlignCenter
                                color: index < passwordField.text.length ? "black" : "#9C98BA"
                            }
                        }
                    }
                }
                ...
                GridLayout {
                    ...
                    Button {
                        ...
                        background: Rectangle {color: "#7F7C95";implicitWidth: 100}
                    }
                    ...
                    Button {
                        ...
                        background: Rectangle {color: "#BD9658";implicitWidth: 100}
                    }
                    Button {
